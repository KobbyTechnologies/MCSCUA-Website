# Generated by Django 4.1.1 on 2022-10-28 05:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(default='SRC Pre-Qualified Suppliers [year]', help_text='At the [year] replace with the tendering year', max_length=255)),
                ('ref_number', models.CharField(max_length=255, unique=True)),
                ('file', models.FileField(upload_to='')),
                ('pub_date', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField()),
